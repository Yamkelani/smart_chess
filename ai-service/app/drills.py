...
DRILLS = [
    ...
    },
    {
        ...
        "tactic": "pawn_fork",
        "title": "Pawn Fork",
        "fen": "r1b1k1nr/pppp1ppp/8/4p3/3nP3/2N5/PPP2PPP/R1BQKB1R w KQkq - 0 1",
        "solution": ["c3d5"],
        "hint": "A pawn advance can fork two pieces.",
        "explanation": "After Nd5 (not a pawn—sorry), the knight forks the bishop on c7 and the knight on e7. Always look for double attacks!",
        "rating": 950,
        "side_to_move": "white",
    },
    ...
    # ══════════════════════════════════════
    {
        ...
        "solution": ["e2e8"],
        "hint": "Force the king to move with a check, then take the piece behind it.",
        "explanation": "Re8+ is a skewer — the king must move, and the rook recaptures or the back rank is open. A skewer is like a reverse pin.",
        "rating": 900,
        "side_to_move": "white",
    },
    {
    ...
    },
    {
        ...
        "title": "Rook Sacrifice for Back Rank Mate",
        "fen": "5rk1/5ppp/8/8/8/8/5PPP/3R2K1 w - - 0 1",
        "solution": ["d1d8", "f8d8"],
        "hint": "Sacrifice a rook to lure the enemy rook off the back rank.",
        "explanation": "Rxd8 sacrifices the rook. After Rxd8, the back rank is now open — but wait, there's no second rook here. Always look for follow-up moves after a sacrifice.",
        "rating": 1200,
        "side_to_move": "white",
    },
